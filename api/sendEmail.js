...
const adminEmail = 'luuvancui10a1516@gmail.com'
const adminPassword = ''
...
const sendMail = () => {
    ...
    const options = {
        ...
        to: 'luuvancui9a2@gmail.com', // địa chỉ gửi đến
        subject: 'Test thử nè', // Tiêu đề của mail
        html: 'Hello' // Phần nội dung mail mình sẽ dùng html thay vì thuần văn bản thông thường.
    }
