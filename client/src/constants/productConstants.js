...
export const PRODUCT_CHECK_EXIST = 'PRODUCT_CHECK_EXIST';
export const PRODUCT_CHECK_FAIL = 'PRODUCT_CHECK_FAIL';
export const PRODUCT_CHECK_REQUEST = 'PRODUCT_CHECK_REQUEST';
export const PRODUCT_CHECK_RESET = 'PRODUCT_CHECK_RESET';
