        ...
        <div>
            ...
            <div className="humberger__menu__wrapper">
                ...
                <div className="humberger__menu__cart">
                    <ul>
                        <li><a href="#sectionsection"><i className="fa fa-heart" /> <span>1</span></a></li>
                        <li><a href="#sectionsection"><i className="fa fa-shopping-bag" /> <span>3</span></a></li>
                    </ul>
                ...
                <div className="humberger__menu__widget">
                    <div className="header__top__right__language">
                        ...
                        <ul>
                            <li><a href="#sectionsection">Spanis</a></li>
                            <li><a href="#sectionsection">English</a></li>
                        </ul>
                    </div>
                ...
                <nav className="humberger__menu__nav mobile-menu">
                    <ul>
                        ...
                        <li><a href="#sectionsection">Pages</a>
